...
public class ConditionalAuthProvider<T> implements InjectableProvider<Auth, Parameter> {
    ...
    private final InjectableProvider<com.yammer.dropwizard.auth.Auth, Parameter> wrappedProvider;

    public ConditionalAuthProvider(InjectableProvider<com.yammer.dropwizard.auth.Auth, Parameter> wrappedProvider, Evaluation<T> evaluation) {
    ...
    private static class DropwizardAuth implements com.yammer.dropwizard.auth.Auth {
        ...
        public Class<? extends Annotation> annotationType() {
            return com.yammer.dropwizard.auth.Auth.class;
        }
    }
}